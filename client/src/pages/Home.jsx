      ...
      <section className="py-14 bg-surface border-t border-gray-100">
        ...
        <div className="marquee-outer">
          <div className="marquee-track"
            ...
            onTouchCancel={(e)=> e.currentTarget.classList.remove('paused')}
          >
...
function TrustChips() {
  const chip = ({ icon: Icon, label, sub, iconBg, pillBg, pillBorder, textColor }, i) => (
    <div key={i}
      className="flex items-center gap-3 px-4 py-3 rounded-2xl transition-all duration-150 active:scale-[0.97] select-none"
